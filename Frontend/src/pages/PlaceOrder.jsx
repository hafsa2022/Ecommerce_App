        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row ">
            <div
              ...
              className="flex items-center gap-3 border p-2px-3 cursor-pointer"
            >
              <p
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "" ? "bg-green-400" : ""}`}
              ></p>
            ...
            >
              ...
              ></p>
              <p className="text-gary-500 text-sm font-medium mx-4">
                CASH ON DELIVERY
              </p>
            </div>
          </div>
